...
pub const HIP_PACKAGE_VERSION_MAJOR: u32 = 6;
pub const HIP_PACKAGE_VERSION_MINOR: u32 = 3;
pub const HIP_PACKAGE_VERSION_PATCH: u32 = 42134;
...
pub const HIP_PACKAGE_VERSION_FLAT: u64 = 6003042134;
...
unsafe extern "C" {
    #[link_name = "\u{1}_Z22getAMDGCNAssemblerPathv"]
    pub fn getAMDGCNAssemblerPath() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[link_name = "\u{1}_Z21getOpenCLCompilerPathv"]
    pub fn getOpenCLCompilerPath() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[link_name = "\u{1}_Z18getHIPCompilerPathv"]
    pub fn getHIPCompilerPath() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    #[link_name = "\u{1}_Z24getOffloadBundlerBinPathv"]
    pub fn getOffloadBundlerBinPath() -> *const ::std::os::raw::c_char;
}
unsafe extern "C" {
    pub fn memcpy(
